...
const hand_2 = new OBJExample( "../models/files/skipgated_MTM/SkipGated_recon_secret_uncorrupted.json",0,0.3,0,true,true,false,false,false,true);
hand_2.initContent();
models.push(hand_2);
...
const hand_4 = new OBJExample( "../models/files/skipgated_MTM/SkipGated_recon_secret_uncorrupted.json",1,0.3,0,true,true,false,false,false,true);
hand_4.initContent();
models.push(hand_4);
