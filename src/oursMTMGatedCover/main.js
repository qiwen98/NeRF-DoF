...
/// order, gt. recon ,both
const hand_1 = new OBJExample( "../models/files/oursgated_MTM/OursGated_gt_cover_uncorrupted.json",-1,0.3,0,true,false,false,false,false,true);
hand_1.initContent();
models.push(hand_1);

const hand_2 = new OBJExample( "../models/files/oursgated_MTM/OursGated_reconstructed_cover_uncorrupted.json",0,0.3,0,true,true,false,false,false,true);
hand_2.initContent();
models.push(hand_2);

const hand_3 = new OBJExample( "../models/files/oursgated_MTM/OursGated_gt_cover_uncorrupted.json",1,0.3,0,true,false,false,false,false,false);
hand_3.initContent();
models.push(hand_3);

const hand_4 = new OBJExample( "../models/files/oursgated_MTM/OursGated_reconstructed_cover_uncorrupted.json",1,0.3,0,true,true,false,false,false,true);
hand_4.initContent();
models.push(hand_4);
