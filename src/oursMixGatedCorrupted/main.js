...
OBJExample.prototype = {
  ...
  createSkinMesh: function () {
    ...
    if (iscorrupted==='corrupted')
    {
      ...
      if (path2_last_element.split('_')[2]==='secret') /// if scret corrupted
      {
        path3='Reconstructed Secret' +'\n'+' given Corrupted Reconstructed Cover'
      }
    }
    else
    {
...
/// order, gt. recon ,both
const human_1 = new OBJExample( "../models/files/Oursgated_Mix/OursGated_reconstructed_cover_uncorrupted.json",-1.5,1.15,0,true,true,false,false,false,true);
human_1.initContent();
models.push(human_1); 

const human_1_2 = new OBJExample( "../models/files/Oursgated_Mix/OursGated_gt_cover_uncorrupted.json",-1.5,1.15,0,true,false,false,false,false,false);
human_1_2.initContent();
models.push(human_1_2); 

const human_1_3 = new OBJExample( "../models/files/Oursgated_Mix/OursGated_reconstructed_cover_corrupted.json",-0.5,1.15,0,true,true,false,false,false,false);
human_1_3.initContent();
models.push(human_1_3); 

const human_2 = new OBJExample( "../models/files/Oursgated_Mix/OursGated_reconstructed_secret_corrupted.json",0.5,0.3,0,true,true,false,false,false,true);
human_2.initContent();
models.push(human_2);

const human_3 = new OBJExample( "../models/files/Oursgated_Mix/OursGated_gt_secret_uncorrupted.json",1.5,0.3,0,true,false,false,false,false,false);
human_3.initContent();
models.push(human_3); 

const human_4 = new OBJExample( "../models/files/Oursgated_Mix/OursGated_reconstructed_secret_corrupted.json",1.5,0.3,0,true,true,false,false,false,true);
human_4.initContent();
models.push(human_4); 
...
// const human_1 = new OBJExample( "../models/files/Oursgated_CMU/OursGated_gt_cover_uncorrupted.json",-1,1.15,0,false,false,false,false,false,true);
// human_1.initContent();
// models.push(human_1); 

// const human_2 = new OBJExample( "../models/files/Oursgated_CMU/OursGated_reconstructed_cover_uncorrupted.json",0,1.15,0,true,true,false,false,false,true);
// human_2.initContent();
// models.push(human_2);
...
// const human_4 = new OBJExample( "../models/files/Oursgated_CMU/OursGated_reconstructed_cover_uncorrupted.json",1,1.15,0,true,true,false,false,false,true);
// human_4.initContent();
// models.push(human_4); 
...
function init() {
  ...
  var text = document.createTextNode("Mix - Our Method");
