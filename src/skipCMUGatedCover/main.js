...
const human_1 = new OBJExample( "../models/files/skipgated_CMU/SkipGated_gt_cover_uncorrupted.json",-1,1.15,0,true,false,false,false,false,true);
human_1.initContent();
models.push(human_1); 

const human_2 = new OBJExample( "../models/files/skipgated_CMU/SkipGated_reconstructed_cover_uncorrupted.json",0,1.15,0,true,true,false,false,false,true);
human_2.initContent();
models.push(human_2);

const human_3 = new OBJExample( "../models/files/skipgated_CMU/SkipGated_gt_cover_uncorrupted.json",1,1.15,0,true,false,false,false,false,false);
human_3.initContent();
models.push(human_3); 

const human_4 = new OBJExample( "../models/files/skipgated_CMU/SkipGated_reconstructed_cover_uncorrupted.json",1,1.15,0,true,true,false,false,false,true);
human_4.initContent();
models.push(human_4); 
