...
const human_2 = new OBJExample( "../models/files/skipgated_CMU/SkipGated_recon_secret_uncorrupted.json",0,1.15,0,true,true,false,false,false,true);
human_2.initContent();
models.push(human_2);
...
const human_4 = new OBJExample( "../models/files/skipgated_CMU/SkipGated_recon_secret_uncorrupted.json",1,1.15,0,true,true,false,false,false,true);
human_4.initContent();
models.push(human_4); 
